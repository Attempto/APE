...
This document explains how to test APE and the various other tools.
...
along with APE's output is stored into directory testruns/
...
if it is not the case then modify tools/rtest.bash accordingly
...
==
cat drace_test_results.txt | grep "FAIL" | grep -v ":" | grep -v "ach of" | wc
==
